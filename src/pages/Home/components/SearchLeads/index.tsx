...
const SearchLeads: React.FC = () => {
  ...
  useEffect(() => {
    api
      .get('/scrapProcesses?category=search_leads')
  ...
  const handleSubmit = useCallback(
    async (data: ScrapProcessFormData) => {
      try {
        ...
        Object.assign(data, { category: 'search_leads' });
        ...
        addToast({
          type: 'success',
          title: 'Search Leads Process Created',
          description:
        ...
        addToast({
          type: 'error',
          title: 'Search Leads Process Error',
          description:
            ...
            {runningProcessExists ? (
              ...
              <ActionButton
                ...
                onClick={() => {
                  api
                    .post(
                      `/scrapProcesses/scrap/${params.row.id}?category=search_leads`,
                    )
                    .then(response => {
                      addToast({
                        type: 'success',
                        title: 'Search Leads Script Running',
          ...
          <ActionButton
            ...
            onClick={() => {
              api.delete(`/scrapProcesses/${params.row.id}`).then(response => {
                addToast({
                  type: 'success',
                  title: 'Search Leads Process deleted',
