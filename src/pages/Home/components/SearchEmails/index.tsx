...
const SearchEmails: React.FC = () => {
  ...
  useEffect(() => {
    api
      .get('/scrapProcesses?category=search_emails')
            ...
            {runningProcessExists ? (
              ...
              <ActionButton
                ...
                onClick={() => {
                  api
                    .post(
                      `/scrapProcesses/scrap/${params.row.id}?category=search_emails`,
                    )
                    .then(response => {
                      addToast({
                        type: 'success',
                        title: 'Search Emails Script Running',
          ...
          <ActionButton
            ...
            onClick={() => {
              api.delete(`/scrapProcesses/${params.row.id}`).then(response => {
                addToast({
                  type: 'success',
                  title: 'Search Emails Process deleted',
  ...
  return (
    <Container>
      <Content>
        <h1>Update Leads Emails by DOT Range</h1>
        <ScrapProcess>
